#!/usr/bin/env python
import roslib
roslib.load_manifest('faa_data_processing')
import rospy

from faa_data_processing.msg import EnteredChamber
...
class TrackingProcessor(object):
  ...
  def __init__(self):
    self.entered_start_chamber_pub = rospy.Publisher("/faa_data_processing/entered_start_chamber",EnteredChamber)
    self.entered_end_chamber_pub = rospy.Publisher("/faa_data_processing/entered_end_chamber",EnteredChamber)
