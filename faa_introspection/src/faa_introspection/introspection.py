...
import roslib
roslib.load_manifest('faa_introspection')
import rospy
import sys
import os
import os.path
...
from faa_utilities import json_tools
from faa_utilities import file_tools

# Services
from faa_msg_and_srv.srv import GetJSONString
...
def get_master():
    ...
    """
    machine_def = get_machine_def()
    return machine_def['faa_master']['address']
...
if __name__ == '__main__':
    ...
    if 0:
        topic_name = '/faa_master/camera_2/camera/seq_and_image_corr'
